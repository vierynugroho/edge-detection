...
image_bright = adjust_brightness(image_sharp, 1.8)
...
# clear noise
bilateral = cv2.bilateralFilter(image_gray, 9, 100, 100)
...
plt.suptitle('Coin Detection', fontsize=16, fontweight='bold')
